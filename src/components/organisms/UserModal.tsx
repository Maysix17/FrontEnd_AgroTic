...
import type { UserModalProps } from "../../types/UserModal.types";
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-7 mt-2">
              <div className="bg-gray-50 p-3 rounded-lg min-h-[64px]">
            ...
            <div className="flex gap-3 justify-center mt-4">
              <Button
                ...
                className="bg-gradient-to-r from-teal-500 to-emerald-500 text-white border-none shadow-md hover:shadow-lg px-4 py-2 rounded-lg font-bold"
              >
                Editar perfil
              </Button>
